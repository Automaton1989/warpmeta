	...
	<div class="container-fluid" id="post">
		...
		<div class="row post-buttons-row">
			<div class="col">
				...
				<button class="btn publish-save-button" onclick="unpublishPost()">Unpublish Post</button>
...
<script>
	...
	function unpublishPost() {
		var p = confirm("Are you sure you want to unpublish this post?")
		if (p == true) {
			window.location.href = "/blog/${post.title}/unpublish";
		}
	}
	...
	*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
	...
	this.page.url = "https://www.warpmeta.com/blog/${post.title}";  // Replace PAGE_URL with your page's canonical URL variable

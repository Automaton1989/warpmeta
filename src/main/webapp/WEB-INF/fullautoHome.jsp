...
<title>WarpMeta Gaming | Full Auto</title>
...
<body class="fade-in">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div id="fullAutoText" class="offset-1 col-10 text-center">
				<p>
					Full Auto is the competitive division of WarpMeta.  Starting with TESL, we're working
					to build an amateur group of teams, including TESL and adding in R6: Siege.  Our goal 
					is to remain competitive, while staying true to our values: keep improving and have fun!
				</p>
				<p>
					Below is the list of teams which are a part of Full Auto: 
				</p>
				<hr my-4>
			</div> 
		</div>
		<div style="margin: 10px;" class="row">
			<div class="offset-1" id="fullAutoTeams">
				<div class="row">
					<div class="col-11 col-sm-11 col-md-11 col-lg-5 col-xl-5">
						<a href="/fullauto/r6">
						<div class="card bg-dark text-white">
						  <img class="card-img" src="/img/R6S.jpg" alt="R6 Team">
						  <div class="card-img-overlay">
						    <h5 class="card-title">Full Auto R6</h5>
						  </div>
						</div>
						</a>
					</div>
					...
					<div class="col-11 col-sm-11 col-md-11 col-lg-5 col-xl-5">
						...
						<div class="card bg-dark text-white">
						  <img class="card-img" src="/img/TESLTeam.jpg" alt="R6 Team">
						  <div class="card-img-overlay">
						    <h5 class="card-title">Full Auto TESL</h5>
						  </div>
						</div>
						</a>
					</div>
